...
class btagSFProducerLatinos(Module):
    ...
    """
    def __init__(self, era, algo='csvv2', selectedWPs=['shape_corr'], sfFileName=None, verbose=0, jesSystsForShape=["jes"]):
        ...
        self.inputFilePath = os.environ['CMSSW_BASE'] + "/src/LatinoAnalysis/NanoGardener/python/data/btagSF/"
        ...
        supported_btagSF = {
            'deepcsv' : {
                ...
                'Full2016v9HIPM_WP' : {
                    'inputFileName' : "wp_deepCSV_106XUL16postVFP_v3.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
                ...
                'Full2016v9HIPM_shape' : {
                    'inputFileName' : "reshaping_deepCSV_106XUL16postVFP_v3.csv",
                    'measurement_types' : {
                        0 : "iterativefit",  # b
                        1 : "iterativefit",  # c
                        2 : "iterativefit"   # light
                ...
                'Full2017v9_WP' : {
                    'inputFileName' : "wp_deepCSV_106XUL17_v3.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
                ...
                'Full2017v9_shape' : {
                    'inputFileName' : "reshaping_deepCSV_106XUL17_v3.csv",
                    'measurement_types' : {
                        0 : "iterativefit",  # b
                        1 : "iterativefit",  # c
                        2 : "iterativefit"   # light
            ...
            'deepjet' : {
                ...
                'Full2016v9HIPM_WP' : {
                    'inputFileName' : "wp_deepJet_106XUL16postVFP_v3.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
                ...
                'Full2017v9_WP' : {
                    'inputFileName' : "wp_deepJet_106XUL17_v3.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
